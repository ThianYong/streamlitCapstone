...
def app():
    ...
    df = pd.read_csv('https://github.com/ThianYong/streamlitCapstone/blob/ecaab9bdad93fb1e7b7895a13fa2ef150a314d1e/data/ETH_1h.csv', parse_dates=['Date'], date_parser=d_parser, index_col='Date')
